...
EXPERIMENTAL_MODELS = [
    ...
    {"name":"llama-3.1-70b",  "family":"Meta",    "provider":"groq",   "model_id":"llama-3.1-70b-versatile",    "max_tokens":2048},
    ...
    {"name":"gpt-4.1-mini",   "family":"OpenAI",  "provider":"openai", "model_id":"gpt-4.1-mini",               "max_tokens":2048},
]

# ═══ 2 JUDGES (no family overlap with experimental models) ═══
JUDGES = [
    {"name":"claude-haiku",    "family":"Anthropic","provider":"anthropic","model_id":"claude-haiku-4-5-20251001","max_tokens":512},
    {"name":"mistral-large-3", "family":"Mistral",  "provider":"mistral",  "model_id":"mistral-large-latest",     "max_tokens":512},
]
...
API_DELAY = 0.3
API_THREADS = 4  # concurrent API calls for speed
